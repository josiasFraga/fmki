...
<div class="card card-primary card-outline">
  ...
  <div class="card-body">
    <?php
      ...
      echo $this->Form->control('academia_id', ['options' => $academias, 'disabled' => 'disabled']);
      echo $this->Form->control('categoria_id', ['options' => $campeonatoCategorias, 'disabled' => 'disabled']);
      echo $this->Form->control('divisao_id', ['options' => $campeonatoDivisoes, 'empty' => true, 'disabled' => 'disabled']);
    ?>
  </div>
